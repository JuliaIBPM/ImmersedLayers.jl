...
"""
struct BasicILMCache{N,SCA<:AbstractScalingType,ND,PHT,BCF,FF,DTF,BLT<:BodyList,NT<:VectorData,
...
"""
    SurfaceScalarCache(g::PhysicalGrid[,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
"""
    SurfaceVectorCache(g::PhysicalGrid[,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
"""
    SurfaceVectorCache(body::Body/BodyList,g::PhysicalGrid[,ddftype=CartesianGrids.Yang3][,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
"""
    SurfaceScalarCache(body::Body/BodyList,g::PhysicalGrid[,ddftype=CartesianGrids.Yang3][,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
"""
    SurfaceScalarCache(X::VectorData,g::PhysicalGrid[,ddftype=CartesianGrids.Yang3][,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
"""
    SurfaceVectorCache(X::VectorData,g::PhysicalGrid[,ddftype=CartesianGrids.Yang3][,scaling=IndexScaling][,phys_params=nothing][,bc=nothing][,forcing=nothing][,timestep_func=nothing])
...
function SurfaceScalarCache(bl::BodyList,a::ScalarData{N},nrm::VectorData{N},g::PhysicalGrid;
   ...
   _surfacecache(bl,X,a,nrm,g,ddftype,scaling,phys_params,bc,forcing,timestep_func,sdata_cache,snorm_cache,gsnorm_cache,gcurl_cache,gdata_cache)
...
function _surfacecache(bl::BodyList,X::VectorData{N},a,nrm,g::PhysicalGrid{ND},ddftype,scaling,phys_params,bc,forcing,timestep_func,
  ...
  return BasicILMCache{N,scaling,ND,typeof(phys_params),typeof(bc),typeof(forcing),typeof(timestep_func),typeof(bl),typeof(nrm),typeof(a),typeof(regop),typeof(Rsn),typeof(Esn),typeof(R),typeof(E),typeof(L),
                       typeof(gsnorm_cache),typeof(gcurl_cache),typeof(gdata_cache),typeof(snorm_cache),typeof(sdata_cache)}(
                       g,phys_params,bc,forcing,timestep_func,bl,nrm,a,regop,Rsn,Esn,R,E,L,
